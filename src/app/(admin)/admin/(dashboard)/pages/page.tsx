...
const fallbackPages: PageRecord[] = [
  {
    ...
    page_type: "landing",
    status: "published",
    seo_title: "Jyoti Educations | Education Consultancy in Nepal",
    ...
    page_sections: [
      {
        ...
        subtitle: "Counseling, test prep, and admission support from Jyoti Educations.",
  ...
  },
  {
    ...
    page_type: "standard",
    status: "published",
    seo_title: "About Jyoti Educations",
    seo_description: "Meet Jyoti Educations's counselors and education support team.",
