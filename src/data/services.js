export const services = [
  {
    ...
    label: "Education",
    text: "Personalized advice to assess your profiles, identify courses of interest, and chart out your academic path.",
  ...
  },
  {
    ...
    label: "Clarity",
    text: "Scientific and structured guidance mapping your psychological profile, skills, and values to modern global careers.",
  ...
  },
  {
    ...
    label: "Destinations",
    text: "Country comparison, course shortlisting, cost-benefit analysis, and post-study work opportunity mappings.",
  ...
  },
  {
    ...
    label: "Visa",
    text: "Comprehensive visa filing checklists, financial statement reviews, mock visa interview training, and strict compliance.",
  ...
  },
  {
    ...
    label: "Admissions",
    text: "Step-by-step assistance in preparing applications, managing deadlines, and coordinating with global university admissions.",
  ...
  },
  {
    ...
    label: "Scholarships",
    text: "Help in identifying merit-based, need-based, and country-specific scholarships, as well as compiling strong portfolios.",
    detail: "Tailored portfolio reviews and application support for tuition fee waivers, merit awards, and university-sponsored grants.",
    bullets: ["Merit & Need Scholarship Finder", "Portfolio & Profile Building", "Essay & Statement Review", "Application Deadlines Alerts"],
    outcomes: ["Optimized scholarship profile", "Submission of funding proposals", "Reduced financial burden"],
  ...
  },
  {
    ...
    label: "Preparation",
    text: "Dedicated mock interview rounds for visa officials, university admissions, and international scholarship panels.",
  ...
  },
  {
    ...
    label: "Documentation",
    text: "SOP reviews, recommendation letter guidelines, CV curation, and translations of academic credentials.",
  ...
  },
  {
    ...
    label: "Test Prep",
    text: "Comprehensive preparation classes for IELTS, PTE, TOEFL, and SAT with certified teachers and mock tests.",
    detail: "Get the best scores with our certified preparation classes. We provide study materials, regular mock tests, and personalized feedback.",
    bullets: ["Certified Instructors", "Weekly Mock Tests", "Interactive Study Material", "Performance Analytics"],
    outcomes: ["Target test scores achieved", "Test-taking confidence", "Improved English proficiency"],
    image: "/images/services/test-prep.jpg"
  },
  {
    title: "Travel & Accommodation",
    slug: "travel-accommodation",
    label: "Logistics",
    text: "Support with flight bookings, travel guidelines, and finding safe student housing or university hostels.",
    detail: "Complete support for travel planning, flight booking guidance, and finding affordable, safe student housing or hostel arrangements near your university.",
    bullets: ["Flight Booking Guidance", "Baggage & Travel Rules", "Hostel & Housing Finder", "Roommate Matching Support"],
    outcomes: ["Confirmed travel tickets", "Pre-booked accommodation", "Smooth arrival coordination"],
    image: "/images/services/travel-accommodation.jpg"
  },
  {
    title: "Pre-Departure Support",
    slug: "pre-departure-support",
    label: "Orientation",
    text: "Comprehensive briefing sessions to prepare you for life, academic culture, and part-time work in your destination country.",
    detail: "Interactive pre-departure briefing covering local culture, climate preparation, academic expectations, banking setups, and part-time work guidelines.",
    bullets: ["Cultural Adaptation Guidance", "Academic Norms Briefing", "Emergency Contact Setup", "What to Pack Checklist"],
    outcomes: ["Complete departure readiness", "Emergency contacts & tips", "Smooth transition overseas"],
