        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 20px" }}>
          ...
          <div className="video-grid" style={{ 
            ...
            {displayVideos.length === 0 ? (
              <div style={{ gridColumn: "1 / -1", textAlign: "center", padding: "80px 20px", background: "var(--white)", borderRadius: "16px", border: "1px solid var(--line)" }}>
                <div style={{ width: "64px", height: "64px", borderRadius: "50%", background: "var(--surface-mist)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}>
                  <Play size={28} style={{ color: "var(--muted)" }} />
                </div>
                <h3 style={{ fontSize: "20px", fontWeight: "800", color: "var(--navy)", marginBottom: "8px" }}>Videos will be added</h3>
                <p style={{ color: "var(--dm-outline)", fontSize: "14px", maxWidth: "400px", margin: "0 auto" }}>
                  Our team is currently preparing informational videos and success stories. Please check back later!
                </p>
              </div>
            ) : (
              filtered.map((video) => (
