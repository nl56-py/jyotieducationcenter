...
const contentSecurityPolicy = [
  ...
  "img-src 'self' data: blob: https://jyotieducation.edu.np https://www.jyotieducation.edu.np https://*.supabase.co https://i.ytimg.com",
  ...
  "media-src 'self' blob: https://jyotieducation.edu.np https://www.jyotieducation.edu.np https://*.supabase.co",
  "manifest-src 'self'",
...
const nextConfig = {
  ...
  serverExternalPackages: ["mysql2", "@prisma/client", "prisma", "bcryptjs"],
};
